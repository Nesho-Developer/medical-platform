...
import { apiResultFormat, patientProfile,  } from '@nts/shared';
...
@Component({
    ...
    imports: [FormsModule, RouterLink, MatTableModule, MatSortModule, MatPaginatorModule, DoctorSidebarComponent, DoctorBreadcrumbComponent]
})

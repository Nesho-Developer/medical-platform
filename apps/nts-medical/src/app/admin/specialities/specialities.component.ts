...
import { pageSelection, apiResultFormat, specialities } from '@nts/shared';
...
export class SpecialitiesComponent {
  ...
  private getTableData(pageOption: pageSelection): void {
    this.data.getSpecialities().subscribe((apiRes: apiResultFormat) => {
      this.tableData = [];
      this.serialNumberArray = [];
      this.totalData = apiRes.totalData;
      apiRes.data.map((res: specialities, index: number) => {

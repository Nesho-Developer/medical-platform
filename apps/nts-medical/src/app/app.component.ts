...
import { NavigationEnd, NavigationStart, Router, Event as RouterEvent, RouterOutlet, RouterLink } from '@angular/router';
...
@Component({
  selector: 'app-root',
  imports: [RouterOutlet, CommonModule, ModalComponent, RouterLink],

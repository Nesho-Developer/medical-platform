...
@Component({
    ...
    imports: [CommonModule,RouterLink,FooterComponent,HeaderComponent,CarouselModule,MatSelectModule,FormsModule,DatePickerModule,BsDatepickerModule,CountUpModule,BsDatepickerModule],
    providers: [DatePipe]
})
